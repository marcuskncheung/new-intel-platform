...
class CaseProfile(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    index = db.Column(db.String(64), unique=True, nullable=False)
    date_of_receipt = db.Column(db.String(64))
    ...
    # Add other fields as needed, matching Access columns
...
def ai_comprehensive_analyze_email(email_id):
    ...
    try:
        ...
        # Get ALL email attachments with CONTENT
        attachments = []
        ...
        for attachment in email_attachments:
            try:
                ...
                print(f"⚠️ Error processing attachment {attachment.filename}: {e}")
                attachments.append({
                    'filename': attachment.filename,
                    'filepath': attachment.filepath,
